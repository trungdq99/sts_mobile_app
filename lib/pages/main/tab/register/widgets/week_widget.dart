...
import 'package:sts/blocs/week_schedule/week_schedule_bloc.dart';
          ...
          BlocConsumer<SelectedWeekCubit, DateTimeRange>(
            ...
            listener: (context, state) {
              BlocProvider.of<ShiftRegistersBloc>(context)
                  .add(ShiftRegistersEventGet(selectedWeek: state));
              BlocProvider.of<WeekScheduleBloc>(context)
                  .add(WeekScheduleEventGet(selectedWeek: state));
            },
